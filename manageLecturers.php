    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            .lecturer-table th, .lecturer-table td { padding: 12px 15px; font-size: 14px; }
            .lecturer-table th { position: static; }
...
<body>
    ...
    <div class="window-frame">
        ...
        <aside class="sidebar">
            <nav>
                <div class="nav-item" onclick="handleLogout(event)">
                    <div class="icon">
                ...
                <div class="nav-item" onclick="window.location.href='announcement.php'">
                    <div class="icon">
