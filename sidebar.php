   ...
   ========================================================================== */
        ...
        @media (max-width: 780px) {
            ...
            .sidebar {
                ...
                width: 100%;
                height: 75px;
                /* Increased slightly to give the larger icons room */
                flex-direction: row;
                justify-content: space-around;
                align-items: center;
                /* Ensures items don't stretch */
                padding-top: 0;
            ...
            .nav-item {
                padding: 5px;
                /* Reduced padding to fit smaller screens better */
                flex: 1;
                /* Distributes space evenly across all 6 buttons */
            }
   ...
   ========================================================================== */
        @media (max-width: 780px) {
            ...
            .sidebar {
                ...
                bottom: 0;
                top: auto;
                /* Reset kedudukan top pada mobile */
                left: 0;
                width: 100%;
                height: 75px;
                flex-direction: row;
